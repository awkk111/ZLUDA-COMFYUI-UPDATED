...
pip install "C:\AmuseConverters\torch-2.2.1+cpu-cp310-cp310-win_amd64.whl"
...
echo  ::  %time:~0,8%  ::  -  Installing older transformer safetensors for older torch.
...
echo.
.\zluda\zluda.exe -- python main.py --auto-launch --reserve-vram 0.6 --use-quad-cross-attention --cuda-device 0 --cache-lru 256 --lowvram
